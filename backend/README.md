...
## Project Structure
    ...
    ├── standalone_fitness_29933  # Django project configurations
...
1. Clone this repo and `cd standalone_fitness_29933`
...
2. Clone this repo and `cd standalone_fitness_29933`
